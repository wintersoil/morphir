...
var $author$project$Morphir$Web$Theme$Light$theme = function (scaled) {
	return {
		...
		highlightColor: $author$project$Morphir$Web$Theme$Light$blue
	};
};
...
var $author$project$Morphir$Visual$Components$AritmeticExpressions$Divide = {$: 'Divide'};
			...
			switch (operatorName) {
				case 'Basics.add':
					return A2(
						...
						A2($author$project$Morphir$Visual$Components$AritmeticExpressions$helperArithmeticFunction, typedValue, operatorName));
				...
				case 'Basics.divide':
					return A2(
						$author$project$Morphir$Visual$Components$AritmeticExpressions$ArithmeticOperatorBranch,
						$author$project$Morphir$Visual$Components$AritmeticExpressions$Divide,
						A2($author$project$Morphir$Visual$Components$AritmeticExpressions$helperArithmeticFunction, typedValue, operatorName));
...
var $author$project$Morphir$Visual$Components$AritmeticExpressions$helperArithmeticFunction = F2(
		...
		if (value.$ === 'Apply') {
			...
			if ((((_v2.a.$ === 'Reference') && _v2.b.b) && _v2.b.b.b) && (!_v2.b.b.b.b)) {
				...
				return _Utils_eq(
					...
					A2($author$project$Morphir$Visual$Components$AritmeticExpressions$helperArithmeticFunction, arg1, operatorName),
					A2($author$project$Morphir$Visual$Components$AritmeticExpressions$helperArithmeticFunction, arg2, operatorName)) : _List_fromArray(
					[
...
var $author$project$Morphir$Visual$ViewArithmetic$view = F2(
	function (viewValue, arithmeticOperatorTree) {
		if (arithmeticOperatorTree.$ === 'ArithmeticOperatorBranch') {
			var operator = arithmeticOperatorTree.a;
			var values = arithmeticOperatorTree.b;
			if (operator.$ === 'Divide') {
				var separator = A2(
					$mdgriffith$elm_ui$Element$column,
					_List_Nil,
